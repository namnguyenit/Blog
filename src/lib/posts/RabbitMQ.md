...
1.  [Giới thiệu về Hệ thống Truyền Thông Điệp](#1-giới-thiệu-về-hệ-thống-truyền-thông-điệp)
    * [1.1. Khái niệm](#11-khái-niệm)
    * [1.2. Lợi ích](#12-lợi-ích)
    * [1.3. Trường hợp sử dụng](#13-trường-hợp-sử-dụng)
2.  [Tìm hiểu về RabbitMQ](#2-tìm-hiểu-về-rabbitmq)
    * [2.1. Tổng quan](#21-tổng-quan)
    * [2.2. Kiến trúc và các Thành phần Chính](#22-kiến-trúc-và-các-thành-phần-chính)
        * [2.2.1. Producer](#221-producer)
        * [2.2.2. Consumer](#222-consumer)
        * [2.2.3. Exchange](#223-exchange)
        * [2.2.4. Queue](#224-queue)
        * [2.2.5. Binding](#225-binding)
        * [2.2.6. Routing Key](#226-routing-key)
        * [2.2.7. Connection và Channel](#227-connection-và-channel)
        * [2.2.8. Virtual Host (vhost)](#228-virtual-host-vhost)
        * [2.2.9. Message](#229-message)
        * [2.2.10. AMQP (Advanced Message Queuing Protocol)](#2210-amqp-advanced-message-queuing-protocol)
    * [2.3. Luồng hoạt động của một tin nhắn](#23-luồng-hoạt-động-của-một-tin-nhắn)
3.  [Chức năng chính của RabbitMQ](#3-chức-năng-chính-của-rabbitmq)
    * [3.1. Độ bền (Durability)](#31-độ-bền-durability)
    * [3.2. Xác nhận tin nhắn (Message Acknowledgements)](#32-xác-nhận-tin-nhắn-message-acknowledgements)
    * [3.3. Lưu trữ tin nhắn bền bỉ (Message Persistence)](#33-lưu-trữ-tin-nhắn-bền-bỉ-message-persistence)
    * [3.4. Publisher Confirms](#34-publisher-confirms)
    * [3.5. Clustering và High Availability](#35-clustering-và-high-availability)
    * [3.6. Security (Bảo mật)](#36-security-bảo-mật)
    * [3.7. Management Plugin](#37-management-plugin)
    * [3.8. Hỗ trợ đa giao thức và thư viện client](#38-hỗ-trợ-đa-giao-thức-và-thư-viện-client)
    * [3.9. Priority Queues (Hàng đợi ưu tiên)](#39-priority-queues-hàng-đợi-ưu-tiên)
    * [3.10. Dead Letter Exchanges (DLX)](#310-dead-letter-exchanges-dlx)
    * [3.11. Lazy Queues](#311-lazy-queues)
4.  [Cài đặt RabbitMQ trên Windows](#4-cài-đặt-rabbitmq-trên-windows)
    * [4.1. Điều kiện tiên quyết: Cài đặt Erlang](#41-điều-kiện-tiên-quyết-cài-đặt-erlang)
        * [4.1.1. Tải và cài đặt Erlang](#411-tải-và-cài-đặt-erlang)
        * [4.1.2. Kiểm tra cài đặt Erlang](#412-kiểm-tra-cài-đặt-erlang)
    * [4.2. Cài đặt RabbitMQ Server](#42-cài-đặt-rabbitmq-server)
        * [4.2.1. Tải và cài đặt RabbitMQ Server](#421-tải-và-cài-đặt-rabbitmq-server)
    * [4.3. Kích hoạt RabbitMQ Management Plugin](#43-kích-hoạt-rabbitmq-management-plugin)
    * [4.4. Khởi động, dừng và quản lý RabbitMQ Service](#44-khởi-động-dừng-và-quản-lý-rabbitmq-service)
5.  [So sánh ngắn gọn RabbitMQ với một số dịch vụ khác](#5-so-sánh-ngắn-gọn-rabbitmq-với-một-số-dịch-vụ-khác)
    * [5.1. RabbitMQ vs. Apache Kafka](#51-rabbitmq-vs-apache-kafka)
    * [5.2. RabbitMQ vs. Redis (Pub/Sub)](#52-rabbitmq-vs-redis-pubsub)
